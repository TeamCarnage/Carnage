...
public class BrineBreakerEntity extends PersistentProjectileEntity {
    ...
    public final static TrackedData<Byte> LOYALTY = DataTracker.registerData(BrineBreakerEntity.class, TrackedDataHandlerRegistry.BYTE);
    public final static TrackedData<Boolean> ENCHANTED = DataTracker.registerData(BrineBreakerEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public BrineBreakerEntity(World world, LivingEntity owner, ItemStack stack) {
        super(EntitiesRegistry.BRINEBREAKER, owner, world, stack, null);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public BrineBreakerEntity(World world, double x, double y, double z, ItemStack stack) {
        super(EntitiesRegistry.BRINEBREAKER, x, y, z, world, stack, stack);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }
    ...
    private void dropStack(ServerWorld serverWorld, ItemStack itemStack, float v) {
    }
