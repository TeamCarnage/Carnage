package xyz.carnage.entity.templates;
...
public class ModTridentEntity extends PersistentProjectileEntity {
    ...
    public ModTridentEntity(EntityType<? extends TridentEntity> entityType, World world) {
        super(entityType, world);
    }

    public ModTridentEntity(World world, LivingEntity owner, ItemStack stack) {
        super(EntityType.TRIDENT, owner, world, stack, null);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
    }

    public ModTridentEntity(World world, double x, double y, double z, ItemStack stack) {
    ...
    public static void initialize() {
        Carnage.LOGGER.info("Registering Trident Entitys for " + Carnage.MOD_ID);
    }
}
