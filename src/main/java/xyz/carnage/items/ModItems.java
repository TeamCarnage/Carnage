...
public final class ModItems {
    ...
    static {
        BLOOD_ESSENCE = Registry.register(Registries.ITEM, Identifier.of(Carnage.MOD_ID, "blood_essence"), new Item(new Item.Settings()));
    }

    public static final Item PHANTOMS_KISS;
    static {
        PHANTOMS_KISS = Registry.register(Registries.ITEM, Identifier.of(Carnage.MOD_ID, "phantoms_kiss"),
